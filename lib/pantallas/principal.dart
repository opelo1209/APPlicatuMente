...
class _PrincipalState extends State<Principal> with TickerProviderStateMixin {
      ...
      appBar: AppBar(
        ...
        actions: [
          ...
          IconButton(
            ...
            onPressed: () => themeProvider.toogleTheme(!isDark),
          ),
          IconButton(
        ...
        children: [
          Row(
            ...
            children: [
              ...
              Image.asset('assets/imagenes/quetzal_3.png', height: 140, width: 140, fit: BoxFit.contain),
            ],
          ),
          const SizedBox(height: 20),
          _serenaQuickCard(isDark),
          const SizedBox(height: 20),
          _buildOptionCard(context, imagePath: 'assets/imagenes/quetzal_2.png', title: 'Últimamente me siento abrumado',        subtitle: 'Vamos a entender qué está pasando',          color: const Color(0xFF66BB6A), onTap: () => _onItemTapped(0)),
          _buildOptionCard(context, imagePath: 'assets/imagenes/quetzal_4.png', title: 'Mis pensamientos me preocupan',         subtitle: 'Hablemos de lo que ronda por tu cabeza',     color: const Color(0xFFA5D6A7), textColor: Colors.black87, onTap: () => _onItemTapped(0)),
          _buildOptionCard(context, imagePath: 'assets/imagenes/quetzal_5.png', title: 'Quiero saber cómo estoy emocionalmente', subtitle: 'Un espacio para conocerte mejor',             color: const Color(0xFFC8E6C9), textColor: Colors.black87, onTap: () => _onItemTapped(0)),
          _buildOptionCard(context, imagePath: 'assets/imagenes/quetzal_6.png', title: 'Solo quiero hablar un poco',            subtitle: 'No tienes que saber qué responder',          color: const Color(0xFFFFF3E0), textColor: Colors.black87, onTap: () => _onItemTapped(0)),
  ...
  Widget _serenaQuickCard(bool isDark) {
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          boxShadow: [BoxShadow(color: _green.withOpacity(isDark ? 0.2 : 0.35), blurRadius: 16, offset: const Offset(0, 6))],
        ),
        child: Row(
          children: [
            _serenaAvatar(radius: 27, borderColor: Colors.white.withOpacity(0.3)),
            const SizedBox(width: 16),
            Expanded(
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  const Text('Habla con Serena', style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold, fontSize: 18)),
                  const SizedBox(height: 4),
                  Text('Tu asistente de bienestar emocional está aquí',
  ...
  Widget _buildOptionCard(BuildContext context, {
    ...
    final isDark     = Provider.of<ThemeProvider>(context).isDarkMode;
    final cardColor  = isDark ? color.withOpacity(0.2) : color;
    final titleColor = isDark ? Colors.white : (textColor == Colors.white ? Colors.white : const Color(0xFF1B5E20));
    final subColor   = isDark ? Colors.white70 : (textColor == Colors.white ? Colors.white70 : const Color(0xFF2E7D32));
          ...
          child: Padding(
            ...
            child: Row(
              children: [
                ...
                Icon(Icons.arrow_forward_ios_rounded, color: titleColor.withOpacity(0.5), size: 16),
              ],
            ),
          ),
        ),
      ...
      child: Column(
        children: [
          ...
          Expanded(
            child: ListView(
              ...
              children: [
                ...
                Divider(color: isDark ? Colors.grey[800] : Colors.grey[200], height: 30),
          ...
          Padding(
            ...
            child: Container(
              decoration: BoxDecoration(
                color: isDark ? const Color(0xFF2C2C2C) : const Color(0xFFFFEBEE),
      ...
      child: SafeArea(
        child: Padding(
          ...
          child: Row(
            ...
            children: [
              _navItem(0, Icons.chat_bubble_outline, 'Serena'),
